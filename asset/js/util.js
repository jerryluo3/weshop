...
util.hidePhoneNumber = function(phone){
...
/**
	构造地址, 
	@params action 系统中的url，格式为 'wxapp/home/navs'
...
/**
	二次封装微信wx.request函数、增加交互体全、配置缓存、以及配合格式化返回数据
...
util.footer = function ($this) {
	...
	that.setData({
		tabBar: tabBar,
    'tabBar.popcartnums': app.globalData.popcartnums,
		'tabBar.thisurl': that.__route__
	})
};

util.popkefu = function () {
  let app = getApp();
};
...
util.interval = function(lastTime, _this, index) {//到期时间戳
