...
<section class="content container-fluid">
	<form role="form" id="dataForm">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="fid" id="fid">
                 ...
                 <?php
					...
					$t_sel = isset($row['cat_fid']) && $clist['cat_id'] == $row['cat_fid']  ? 'selected' : '';
				 ?>
          ...
          <div class="box-footer">
            ...
            <button type="button" class="btn btn-primary" onClick="checkLinksCatesMod();">确定提交</button>　
...
function checkLinksCatesMod(){
	...
	var url = "ajax_admin/linksCatesMod";
	...
	$.ajax({
		...
		success: function(msg){
			...
			if(msg.status == 200){
				...
				loadinghide();
				$(".close").click();
				go('<?php echo admin_url()."Linkscates/index"?>');	
			}
		}
	});
