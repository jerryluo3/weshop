	...
	<div class="box box-primary">
    		<div class="box-header with-border">
              ...
              <div class="pull-left col-sm-4">
                <a href="javascript:;"onclick="openModel('admin/member/onrecharge/', '会员充值');" class="btn btn-sm btn-info btn-down"><i class="fa fa-plus" title="会员充值"></i> 会员充值</a>　<a href="javascript:;"onclick="openModel('admin/member/exportMemberRecharge/', '导出消费明细');" class="btn btn-sm btn-info btn-down"><i class="glyphicon glyphicon-download-alt" title="导出充值明细"></i> 导出充值明细</a>
              </div>
