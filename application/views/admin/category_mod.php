...
<section class="content container-fluid">
	<form role="form" id="dataForm">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group input-group-sm">
                <input type="text" class="form-control" name="cat_img" id="picture" value="<?php echo isset($row['cat_img']) ? $row['cat_img'] : set_value('cat_img');?>">
                    <span class="input-group-btn">
          ...
          <div class="box-footer">
            ...
            <button type="button" class="btn btn-primary" onClick="checkCatMod();">确定提交</button>　
	...
	$.ajax({
		...
		success: function(msg){
			...
			if(msg.status == 200){
				...
				loadinghide();
				$(".close").click();
				go('<?php echo admin_url()."category/index"?>');	
			}
		}
	});
