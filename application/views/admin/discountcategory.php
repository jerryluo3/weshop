	...
	<div class="box">
            <div class="box-header row">
              ...
              <div class="pull-left col-sm-6">
                <a href="javascript:;" onclick="openModel('<?php echo site_url(admin_url().'discountcategory/mod/add');?>', '编辑类别信息');" class="btn btn-sm btn-info btn-flat"><i class="fa fa-plus-circle" title="添加类别"></i> 添加类别</a>
