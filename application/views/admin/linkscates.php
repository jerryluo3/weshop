	...
	<div class="box">
            <div class="box-header row">
              ...
              <div class="pull-left col-sm-8">
                <a href="javascript:;" onclick="openModel('<?php echo site_url(admin_url().'linkscates/mod/add');?>', '编辑链接类别信息');" class="btn btn-sm btn-info btn-flat"><i class="fa fa-plus-circle" title="添加链接类别"></i> 添加链接类别</a>
            ...
            <div class="box-body no-padding">
              <table class="table table-striped table-bordered">
                 <tbody>
                    ...
                    <?php
						foreach($linkscates_list as $list):
					?>
					<tr>
					...
					<td><a href="javascript:;" onclick="openModel('<?php echo admin_url();?>linkscates/mod/<?php echo $list['cat_id'];?>', '编辑链接类别信息');"><i class="fa fa-edit"></i></a>　<a href="javascript:;" onClick="delmsg('<?php echo admin_url();?>linkscates/del/<?php echo $list['cat_id'];?>', this, <?php echo $list['cat_id'];?>);"><i class="fa fa-trash"></i></a></td>
					</tr> 
					<?php endforeach ?>
                  </tbody>
              </table>
