...
class Discount_model extends CI_Model {
	...
	public function getdiscountList()
	{
		...
		$total_nums = $this->db->where(array('mid'=>$mid))->count_all_results('discount');
		$page_size = 20;
		...
		$data['discount_list'] = $this->db->where(array('mid'=>$mid))->order_by('id','DESC')->limit($page_size,$offset)->join('discountcategory','discountcategory.cat_id = discount.cid','left')->get('discount')->result_array();
