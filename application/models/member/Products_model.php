...
class Products_model extends CI_Model {
	...
	public function getproductsList()
	{
		...
		$total_nums = $this->db->where(array('uid'=>$mid))->count_all_results('products');
		$page_size = 20;
		...
		$data['products_list'] = $this->db->where(array('uid'=>$mid))->order_by('id','DESC')->limit($page_size,$offset)->join('productscategory','productscategory.cat_id = products.cid','left')->get('products')->result_array();
