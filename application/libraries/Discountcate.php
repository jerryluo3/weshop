				...
				foreach($arr as $k=>$res){
					if(isset($arr[$k])){
						...
						if($optionlist == 1){//下拉框
							...
							$mod_name = 'discountcategory';
							$mod_op = '<a href="javascript:;" onclick="openModel(\''.admin_url().'discountcategory/mod/'.$res['cat_id'].'\', \'编辑商品信息\');"><i class="fa fa-edit"></i></a>';
							$del_op = '　<a href="javascript:;" onClick="delmsg(\''.admin_url().'discountcategory/del/'.$res['cat_id'].'\', this, '.$res['cat_id'].');"><i class="fa fa-trash"></i></a>';
						$this->str .= '<tr>
